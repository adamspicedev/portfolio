...
import FrontEndDev from './frontenddev.jpg'

export const meta = {
  author: 'Adam Spice',
  date: '2023-06-01',
  title:
    'The Evolution of Modern Front-End Web Development: A Revolution in Workflow',
  description:
    'Front-end web development has witnessed a remarkable transformation in recent years, with new technologies, frameworks, and tools revolutionizing the way websites and web applications are built.',
}
...
<Image src={FrontEndDev} alt="front end development" />
