...
import Recursion from './recursion.png'
...
export const meta = {
  ...
  description:
    'Recursion is a fundamental concept in computer science and programming that involves solving problems by breaking them down into smaller, more manageable subproblems.',
...
<Image src={Recursion} alt="An image show ing recursion" />
